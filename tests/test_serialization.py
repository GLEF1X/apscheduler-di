...
from apscheduler_di.serialization import TransferredBetweenProcessesJob
...
def test_pickle_special_job():
    ...
    job = TransferredBetweenProcessesJob(MockScheduler(), provider,
                                         func=example_job,
...
def test_pickle_special_job_with_ssl_context():
    ...
    job = TransferredBetweenProcessesJob(scheduler, provider,
                                         func=example_job2,
                                         trigger=CronTrigger(second=5),
                                         kwargs={},
                                         args=(ssl.SSLContext(),),
